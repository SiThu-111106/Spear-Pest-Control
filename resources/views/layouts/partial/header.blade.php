...
<head>
    <meta charset="utf-8">
    <title>Spear Pest Control</title>
            ...
            <div class="d-flex justify-content-between topbar py-2">
                <div class="d-flex align-items-center flex-shrink-0 topbar-info">
                    ...
                    <a href="#" class="text-secondary"><i
                            class="fas fa-envelope me-2 text-dark"></i>Sithunyeinchanwin@gmail.com</a>
                </div>
                ...
                <div class="d-flex align-items-center justify-content-center topbar-icon">
                    <a href="https://www.facebook.com/" class="me-4"><i class="fab fa-facebook-f text-dark"></i></a>
                    <a href="https://twitter.com/?lang=en" class="me-4"><i class="fab fa-twitter text-dark"></i></a>
                    <a href="https://www.instagram.com/" class="me-4"><i class="fab fa-instagram text-dark"></i></a>
                    <a href="https://www.linkedin.com/" class=""><i class="fab fa-linkedin-in text-dark"></i></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <nav class="navbar navbar-dark navbar-expand-lg py-lg-0">
                <a href="index.html" class="navbar-brand">
                    <h1 class="text-primary mb-0 display-5">Spear<span class="text-white">PestControl</span><i
                ...
                <div class="collapse navbar-collapse me-n3" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pest Libraries</a>
                            <div class="dropdown-menu m-0 bg-primary">
                                <a href="/blog" class="dropdown-item">Blog Post</a>
                                <a href="/member" class="dropdown-item">Team Members</a>
