...
<div class="container-fluid services py-5">
    <div class="container text-center py-5">
        ...
        <div class="row g-5">
            ...
            <div class="col-xxl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".9s">
                <div class="bg-light rounded p-5 services-item">
                    <div class="d-flex" style="align-items: center; justify-content: center;">
                        <img class="mb-4 w-50 h-50 rounded-circle"
                            src="./frontend/img/mosquitoes.jpeg">
                    </div>
                    <h4 class="text-center">Mosquitoes</h4>
                    <p class="text-center fs-5">Mosquitoes are a type of blood-feeding fly that make up the Culcidia
                        family. They are over 3,450 species distributed worldwide, spreading from the tropics to the
                        Arctic circle.</p>
                    <button type="button" onclick="window.location.href='/blog'" class="btn btn-primary border-0 rounded-pill px-4 py-3">Learn More</button>
                </div>
            </div>
            <div class="col-xxl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".9s">
                <div class="bg-light rounded p-5 services-item">
                    <div class="d-flex" style="align-items: center; justify-content: center;">
                        <img class="mb-4 w-50 h-50 rounded-circle"
                            src="./frontend/img/flies.jpeg">
                    </div>
                    <h4 class="text-center">Flies</h4>
                    <p class="text-center fs-5">Flies are in the order Diptera, coming from the greek words 'di' meaning
                        'two', and 'ptera' meaning wings. This characteristic differentiates this group from most other
                        insect species. Although mostly two-wings, some species of flies have developed an additional
                        pair of club-shaped wings.</p>
                    <button type="button" onclick="window.location.href='/blog'" class="btn btn-primary border-0 rounded-pill px-4 py-3">Learn More</button>
                </div>
            </div>
            <div class="col-xxl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".9s">
                <div class="bg-light rounded p-5 services-item">
                    <div class="d-flex" style="align-items: center; justify-content: center;">
                        <img class="mb-4 w-50 h-50 rounded-circle"
                            src="./frontend/img/rodent.jpeg">
                    </div>
                    <h4 class="text-center">Rodents</h4>
                    <p class="text-center fs-5">Rodents comprise the largest group in the mammalian kingdom,
                        representing 42% of all mammal species. There are four families of rodents, the largest of which
                        is the Muridae family. All of the rats featured below are part of a sub-family called Murinae
                        (Murine rodents).</p>
                    <button type="button" onclick="window.location.href='/blog'" class="btn btn-primary border-0 rounded-pill px-4 py-3">Learn More</button>
                </div>
            </div>
